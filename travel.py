...
API_KEY = os.getenv("AIzaSyCKvEtJKsO8PtgUBL2wUr4piGCAJgSB5DI")
...
if st.button("Your Travel Plan"):
    if source and destination:
        with st.spinner("Compiling all travel options...."):
            ...
            chat_model = ChatGoogleGenerativeAI(api_key = "AIzaSyBZHzfP4fLVmwaY_rLrfUHjYt4woJ8xFto", model = "gemini-2.0-flash-exp")
